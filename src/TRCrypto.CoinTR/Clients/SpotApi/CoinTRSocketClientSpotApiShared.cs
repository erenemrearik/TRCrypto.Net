...
/// <summary>
/// CoinTR spot WebSocket API'sinin borsadan bagimsiz yuzeyi.
/// </summary>
/// <remarks>
/// Ticker, islem ve emir defteri akislari anahtarsiz calisir. Ayni yuzeyi uygulayan
/// BtcTurk ve Binance TR istemcileriyle birlikte kullanildiginda cagiran taraf borsaya
/// ozgu hicbir ayrintiyi bilmek zorunda kalmaz.
/// </remarks>
internal partial class CoinTRSocketClientSpotApi : ICoinTRSocketClientSpotApiShared
{
    /// <inheritdoc />
        ...
        CancellationToken ct)
    {
        ...
        return await SubscribeToTickerUpdatesAsync(symbol, update => handler(Convert(update,
            new SharedSpotTicker(
                ...
                // Borsa degisimi kesir olarak gonderir; shared sozlesmesi yuzde bekler.
        ...
        CancellationToken ct)
    {
        ...
        // Akis islemleri tek tek gonderir; shared sozlesmesi dizi bekledigi icin her
        // guncelleme tek ogeli bir dizi olarak aktarilir.
    ...
    // Kademe sayisi kanal adinin parcasidir; borsa yalnizca bu ucunu tanir.
    SubscribeOrderBookOptions IOrderBookSocketClient.SubscribeOrderBookOptions { get; }
        = new(CoinTRExchange.ExchangeName, false, _orderBookLevels);
